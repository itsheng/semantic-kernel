...
@fixture()
def groq_unit_test_env(monkeypatch, exclude_list, override_env_param_dict):
    """Fixture to set environment variables for GroqSettings."""
    if exclude_list is None:
        exclude_list = []
    ...
    env_vars = {"GROQ_CHAT_MODEL_ID": "test_chat_model_id", "GROQ_API_KEY": "test_api_key"}
